...
**Missions :** Assurer la structuration et le pilotage des relations inter-directions, en formalisant

les engagements, contrats de service et instances de gouvernance nécessaires à la

continuité et à la performance globale.

Contribuer à la régulation du fonctionnement inter-directions, dans le cadre des

orientations validées par la BU.

Place dans l'organigramme : N -2 (par rapport au directeur opérationnel)

Fonction du supérieur hiérarchique directe : chef du service pilotage et
